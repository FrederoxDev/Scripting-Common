import { BlockComponentBlockBreakEvent, BlockComponentEntityFallOnEvent, BlockComponentOnPlaceEvent, BlockComponentPlayerBreakEvent, BlockComponentPlayerInteractEvent, BlockComponentPlayerPlaceBeforeEvent, BlockComponentRandomTickEvent, BlockComponentStepOffEvent, BlockComponentStepOnEvent, BlockComponentTickEvent, BlockCustomComponent, CustomComponentParameters } from "@minecraft/server";
...
export interface BlockCustomComponentV2 extends BlockCustomComponent {
    ...
    onBreak?(ev: BlockComponentBlockBreakEvent, params: CustomComponentParameters): void;
